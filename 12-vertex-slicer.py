...
def plot_slices(vertices, faces, a=None, b=None, c=None,
    ...
    ax.set_title('12-Vertex 2-Torus Slicer — axis slices + free-orientation plane')
...
if __name__ == "__main__":
    # data 5 is very nice 
    V = np.array([
        [-0.40125929415651407,-0.59971068598407495,-0.21300738855486712], 
        [-0.74004321723457567,-0.034941889351225948,-0.1733653414584003], 
        [-0.04732629255018881,0.73907489945055749,-0.16861250167617114],
        [0.5681871259702056,-0.43330469720662967,-0.0086153690334879567],
        [-0.62117182011833105,-0.037997354165642268,-0.0054573492600453631],
        [-0.49006361499684487,0.164304969366562,0.37728240978577321],
        [0.40125929415651407,0.59971068598407495,-0.21300738855486712],
        [0.74004321723457567,0.034941889351225948,-0.1733653414584003],
        [0.04732629255018881,-0.73907489945055749,-0.16861250167617114],
        [-0.5681871259702056,0.43330469720662967,-0.0086153690334879567],
    ...
    F = np.array([
        [0, 1, 5], [0, 4, 8], [0, 5, 11], [0, 6, 1], [0, 7, 6], [0, 8, 7], [0, 11, 4],
        [1, 2, 7], [1, 6, 2], [1, 7, 8], [1, 8, 9], [1, 9, 5], [2, 3, 7], [2, 6, 10],
        [2, 8, 3], [2, 9, 8], [2, 10, 9], [3, 4, 9], [3, 8, 4], [3, 9, 10], [3, 10, 11],
        [3, 11, 7], [4, 5, 9], [4, 10, 5], [4, 11, 10], [5, 6, 11], [5, 10, 6], [6, 7, 11]
    ])
